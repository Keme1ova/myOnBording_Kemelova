package com.example.myonbording_kemelova.ui.home;
...
import com.example.myonbording_kemelova.databinding.FragmentHomeBinding;
import com.example.myonbording_kemelova.models.ModelDo;
import com.example.myonbording_kemelova.remote_data.RetrofitBuilder;
        ...
        binding.zoomBtn.setOnClickListener(v1 ->{
            if(binding.link.getText().toString() !=null){
                try{
                    ...
                    Toast.makeText(requireActivity(), "Link is not",
                            Toast.LENGTH_SHORT).show();
                }
            }
        });
